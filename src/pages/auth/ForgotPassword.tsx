...
export default function ForgotPassword() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // Cast to access mock-specific fields
      const data = response as unknown as { resetLink?: string; token?: string }
      const resetLink = data.resetLink
      if (resetLink) {
        // Navigate using the exact link the server returned
      ...
      <section className="auth-page__panel">
        ...
        <form className="auth-page__card" onSubmit={handleSubmit} noValidate>
          <div>
            ...
            <p>
              Enter the email address linked to your TSL account and we'll send
              you a reset link.
            </p>
          </div>
