      ...
      <Container className="max-w-[1320px]">
        ...
        >
          {metrics.map(({ icon: Icon, value, label }) => (
            ...
            >
              <span className="grid h-[40px] w-[40px] place-items-center rounded-[12px] text-white" style={{background:'linear-gradient(135deg,#F0B100 0%,#D08700 100%)',boxShadow:'0px 4px 6px -1px rgba(0,0,0,0.1),0px 2px 4px -2px rgba(0,0,0,0.1)'}}>
