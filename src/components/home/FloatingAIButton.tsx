...
export function FloatingAIButton() {
  ...
  return (
    <>
      ...
      <motion.button
        type="button"
        className="fixed bottom-5 right-5 z-50 inline-flex min-h-13 items-center gap-3 rounded-full bg-gold px-7 text-white shadow-premium md:bottom-8 md:right-8 tsl-ai-fab-label"
