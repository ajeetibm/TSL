...
export const counselApi = {
  ...
  createPublicFundingReview: (payload: JsonRecord) => request<{ requestId: string; status: 'pending' | 'approved' | 'rejected'; rejectionReason?: string | null; duplicate?: boolean }>('/api/v1/sme/counsel/public-funding-review', 'POST', payload),
